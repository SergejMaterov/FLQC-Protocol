...
[Fundamental Limit of Quantum Computation (FLQC)](https://doi.org/10.5281/zenodo.21546403)
...
methodology described in the [FLQC manuscript (§4.1)](https://doi.org/10.5281/zenodo.21546403), useful for:
...
§4.3](https://doi.org/10.5281/zenodo.21546403), for the full derivation of the gap above, and the note on why chaotic (OTOC) amplification does not close it either.
